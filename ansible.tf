...
resource "null_resource" "ansible" {
  ...
  provisioner "local-exec" {
    command = "ansible-playbook -i ${path.module}/resources/templates/inventory.tpl -e @${path.module}/resources/ansible/extra_vars.yml ${path.module}/resources/ansible/gitlab_setup.yml"
